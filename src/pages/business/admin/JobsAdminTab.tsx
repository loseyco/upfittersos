...
export function JobsAdminTab(_props: { tenantId: string }) {
    return (
        <div className="flex flex-col h-full bg-zinc-950 relative items-center justify-center p-6 text-center">
            ...
            <h2 className="text-3xl font-black text-white tracking-tight mb-3">Job Management</h2>
            <p className="text-zinc-400 max-w-md text-sm leading-relaxed mb-8">
                A unified hub for dispatching technicians, managing work orders, assigning tasks, and tracking revenue across commercial clients.
            </p>
            ...
            <div className="bg-orange-500/5 border border-orange-500/20 px-6 py-4 rounded-xl flex items-start gap-4 max-w-md text-left shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-orange-400/80 text-xs leading-relaxed">
                        Job Management routes are deployed. The kanban tracking interface and field-tech dispatch controls are currently being built by our engineering team.
                    </p>
                </div>
            </div>
        </div>
