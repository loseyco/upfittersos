...
export function FinancesAdminTab(_props: { tenantId: string }) {
    return (
        <div className="flex flex-col h-full bg-zinc-950 relative items-center justify-center p-6 text-center">
            <div className="relative mb-8">
                <div className="absolute inset-0 bg-emerald-500/20 blur-3xl rounded-full"></div>
                <div className="w-24 h-24 bg-zinc-900 border border-zinc-800 rounded-3xl flex items-center justify-center shadow-2xl relative z-10">
            ...
            <h2 className="text-3xl font-black text-white tracking-tight mb-3">Finances & Billing</h2>
            <p className="text-zinc-400 max-w-md text-sm leading-relaxed mb-8">
                A centralized financial hub for generating invoices, processing payments via Stripe, and tracking operational revenue and expenses.
            </p>
            ...
            <div className="bg-orange-500/5 border border-orange-500/20 px-6 py-4 rounded-xl flex items-start gap-4 max-w-md text-left shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-orange-400/80 text-xs leading-relaxed">
                        The accounting ledgers and payment gateways are currently undergoing security audits. Full invoicing capabilities will launch next quarter.
                    </p>
                </div>
            </div>
        </div>
