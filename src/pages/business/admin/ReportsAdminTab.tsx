...
export function ReportsAdminTab(_props: { tenantId: string }) {
    return (
        <div className="flex flex-col h-full bg-zinc-950 relative items-center justify-center p-6 text-center">
            ...
            <h2 className="text-3xl font-black text-white tracking-tight mb-3">Reports & Analytics</h2>
            <p className="text-zinc-400 max-w-md text-sm leading-relaxed mb-8">
                Comprehensive data visualization and metrics for crew efficiency, revenue tracking, and operational velocity.
            </p>
            ...
            <div className="bg-orange-500/5 border border-orange-500/20 px-6 py-4 rounded-xl flex items-start gap-4 max-w-md text-left shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-orange-400/80 text-xs leading-relaxed">
                        Data ingestion pipelines are currently collecting structural analytics. Custom dashboards will be exposed once the historical dataset matures.
                    </p>
                </div>
            </div>
        </div>
