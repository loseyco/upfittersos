...
export function IdeaEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, style = {}, markerEnd, data }: EdgeProps<Edge<IdeaEdgeData>>) {
  ...
  if (readOnly) {
    return <BaseEdge path={activePath} markerEnd={markerEnd} style={style} />;
  }
