...
function BetaJobDetailsModal({ tenantId, job, onClose, onUpdate }: JobDetailsModalProps) {
  ...
  const handleUpdateTask = async (taskId: string, updates: any) => {
    ...
    if ((updates.status === 'QC' || updates.status === 'QC Complete' || updates.status === 'completed') && existingTask?.canComplete === false) {
            ...
            return (
              ...
              <div key={group} className="space-y-3">
                ...
                {groupTasks.sort((a, b) => {
                  ...
                  const progress = bookHours > 0 ? Math.min(100, (loggedHours / bookHours) * 100) : 0;
                  ...
                  return (
                    ...
                    <div key={task.id} className={cn(
                      ...
                      task.isAccidental
                          ...
                          <div className="flex-1 min-w-0">
                             ...
                             <div className="flex items-center gap-2 mb-1">
                                ...
                                >
                                  ...
                                  {task.canComplete !== false && <option value="QC">QC</option>}
                                  ...
                                  {task.canComplete !== false && <option value="QC Complete">QC Complete</option>}
                                  ...
                                  {task.canComplete !== false && <option value="completed">Completed</option>}
                       ...
                       {task.payBasis !== 'hourly' && task.bookTime > 0 && (
