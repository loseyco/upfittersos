...
export function TimeclockMonitorAuthWrapper() {
  ...
  useEffect(() => {
    ...
    const authenticate = async () => {
      try {
        ...
        console.error('Timeclock Station Auto-login failed:', err);
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-8">
        <div className="bg-red-950/50 border border-red-900 rounded-2xl p-8 max-w-2xl w-full text-center">
          <h2 className="text-2xl font-black text-red-500 mb-4 uppercase tracking-wider">Timeclock Station Error</h2>
  ...
  if (!isAuthenticated || !tenantId) {
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center">
        ...
        <div className="text-xl font-bold tracking-widest uppercase text-zinc-500 animate-pulse">Initializing Timeclock Station...</div>
      </div>
    );
  }
