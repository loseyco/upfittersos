...
exports.onJobTaskWritten = functions.firestore.onDocumentWritten('businesses/{tenantId}/jobs/{jobId}/tasks/{taskId}', async (event) => {
    ...
    try {
            ...
            for (const sessionDoc of sessionsSnap.docs) {
                ...
                const updatedJobs = jobs.map((j) => {
                    if (j.id === jobId && j.taskId === taskId && !j.end) {
                        updated = true;
                        return Object.assign(Object.assign({}, j), { end: admin.firestore.Timestamp.now() });
                    }
                    return j;
                });
                if (updated) {
        ...
        const currentJobStatus = jobData === null || jobData === void 0 ? void 0 : jobData.status;
        if (!currentJobStatus)
            return;
        ...
        const hasVin = !!((jobData === null || jobData === void 0 ? void 0 : jobData.vehicleId) || (jobData === null || jobData === void 0 ? void 0 : jobData.vehicle) || ((jobData === null || jobData === void 0 ? void 0 : jobData.qbCustomFields) && (jobData.qbCustomFields.vin || jobData.qbCustomFields['VIN num'])));
        const hasStatus = !!((jobData === null || jobData === void 0 ? void 0 : jobData.status) && jobData.status !== 'Open');
        ...
        const attentionChanged = (jobData === null || jobData === void 0 ? void 0 : jobData.needsAttention) !== needsAttention ||
            JSON.stringify((jobData === null || jobData === void 0 ? void 0 : jobData.needsAttentionReasons) || []) !== JSON.stringify(needsAttentionReasons);
        let newStatus = null;
